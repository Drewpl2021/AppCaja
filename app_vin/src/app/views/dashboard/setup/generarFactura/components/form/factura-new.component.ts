                ...
                <div class="invoice">
                    ...
                    <div class="details">
                        <div style="display: flex; ">
                            ...
                            <div style="flex: 1; font-size: 17px; text-align: left;"><strong>N° Factura:</strong> CAJA01
                            </div>
                        </div>

                        <div style="display: flex; margin-top: -15px">
                            <div style="flex: 1; font-size: 17px;"><strong>RUC/DNI:</strong> 75218458</div>
                            <div style="flex: 1; font-size: 17px; text-align: left;"><strong>Fecha:</strong> 01/01/2024
                            </div>

                        </div>
                        <div style="display: flex; margin-top: -15px">
                            <div style="flex: 1; font-size: 17px;"><strong>Dirección:</strong> Jr. las malvinas 720
                            </div>
                        </div>
                    </div>
